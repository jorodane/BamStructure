...
namespace RoofsOnRoofs
{
    ...
    public class Placeworker_Roof : PlaceWorker
    {
        public override void DrawGhost(ThingDef def, IntVec3 center, Rot4 rot, Color ghostCol, Thing thing = null)
        {
            ...
            ghostCol.a = 0.8f;
            mat.color = ghostCol;
            Graphics.DrawMesh(finalGraphic.MeshAt(rot), center.ToVector3ShiftedWithAltitude(def.altitudeLayer + 1), finalGraphic.ShouldDrawRotated ? rot.AsQuat : Quaternion.identity, mat, 0);
        }
